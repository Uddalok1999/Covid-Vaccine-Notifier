...
- Code source: Download latest zip file `covid-vaccine-notifier-lambda.zip` from [github release here](https://github.com/warrensbox/covid-vaccine-tracker/releases)
